...
MODE.FootStepsDrawDistanceSqr = 240
...
hook.Add("PostDrawTranslucentRenderables", "HS_Professions_Abilities", function()
	...
	if LocalPlayer().role == "seeker" then
		local frame_time = FrameTime()
...
hook.Add("Think", "HS_Professions_Abilities", function()
...
hook.Add("PostCleanupMap", "HS_Professions_Abilities", function()
	MODE.FootSteps = {}
	MODE.ArrangedFootSteps = {}
	MODE.FootStepsAmt = 0
end)

net.Receive("HS_Professions_Abilities_AddFootstep", function()
	MODE.AddFootstep(net.ReadVector(), net.ReadFloat(), net.ReadBool(), net.ReadColor(false))
end)

-- The below code is actually super nifty, but it needs to be reworked.
